...
*/
if (!function_exists('mp_stacks_tweet_grid_plugin_check')){
	function mp_stacks_tweet_grid_plugin_check( $plugins ) {
		
		$add_plugins = array(
			array(
				'plugin_name' => 'MP Stacks + Embed Tweets',
				'plugin_message' => __('You require the MP Stacks + Embed Tweets plugin. Install it here.', 'mp_stacks_tweet_grid'),
				'plugin_filename' => 'mp-stacks-tweet-grid.php',
				'plugin_download_link' => 'http://mintplugins.com/repo/mp-stacks-tweet-grid/?downloadfile=true',
...
add_filter( 'mp_core_check_plugins', 'mp_stacks_tweet_grid_plugin_check' );