 ...
 * @return   void
 */
function mp_stacks_embed_tweets_add_media_type( $mp_stacks_content_types_array ){	
...
add_filter('mp_stacks_content_types_array', 'mp_stacks_embed_tweets_add_media_type');